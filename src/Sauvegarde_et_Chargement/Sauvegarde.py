...
def information_sauvegarde():
    ...
    all_files = os.listdir("data/Liste_sauvegardes")
    ...
    for x in sauvegardes:
        derniere_date_modification.append(time.ctime(os.path.getmtime('data/Liste_sauvegardes/' + x)))
        date_creation.append(time.ctime(os.path.getctime('data/Liste_sauvegardes/' + x)))
